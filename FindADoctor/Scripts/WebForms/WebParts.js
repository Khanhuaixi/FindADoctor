...
function WebPartMenu_Show() {
    ...
    var menuHTML =
        ...
        "</style><body scroll=\"no\" style=\"border: none; margin: 0; padding: 0;\" ondragstart=\"window.event.returnValue=false;\" onclick=\"PopUpModal.hide()\">" +
        this.menuElement.innerHTML +
        "</body></html>";
    var width = 16;
    var height = 16;
    this.PopUpModal = window.createPopUpModal();
    __wpm.menu = this;
    var PopUpModalDocument = this.PopUpModal.document;
    PopUpModalDocument.write(menuHTML);
    this.PopUpModal.show(0, 0, width, height);
    var PopUpModalBody = PopUpModalDocument.body;
    width = PopUpModalBody.scrollWidth;
    height = PopUpModalBody.scrollHeight;
    ...
    if (this.menuElement.innerHTML.indexOf("progid:DXImageTransform.Microsoft.Shadow") != -1) {
        PopUpModalBody.style.paddingRight = "4px";
    }
    PopUpModalBody.__wpm = __wpm;
    PopUpModalBody.__wpmDeleteWarning = __wpmDeleteWarning;
    PopUpModalBody.__wpmCloseProviderWarning = __wpmCloseProviderWarning;
    PopUpModalBody.PopUpModal = this.PopUpModal;
    this.PopUpModal.hide();
    this.PopUpModal.show(0, this.menuLabelElement.offsetHeight, width, height, this.menuLabelElement);
}
function WebPartMenu_Hide() {
    if (__wpm.menu == this) {
        __wpm.menu = null;
        if ((typeof(this.PopUpModal) != "undefined") && (this.PopUpModal != null)) {
            this.PopUpModal.hide();
            this.PopUpModal = null;
        }
    }
