    ...
    if (this._anchor) {
        ...
        if (subMenu) {
            ...
            if (!this.childMenu.isStatic()) {
                Sys.WebForms.Menu._domHelper.appendCssClass(this.element, 'has-PopUpModal');
                Sys.WebForms.Menu._domHelper.appendAttributeValue(this.element, 'aria-hasPopUpModal', this.childMenu.element.id);
            }
        }
    }
